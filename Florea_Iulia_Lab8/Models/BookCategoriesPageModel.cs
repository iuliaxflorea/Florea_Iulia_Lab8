...
namespace Florea_Iulia_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Florea_Iulia_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Florea_Iulia_Lab8Context context,
